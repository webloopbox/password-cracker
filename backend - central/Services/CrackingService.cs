namespace backend___central.Services
{
    public class CrackingService(IEnumerable<ILogService> logServices) : ICrackingService
    {
        ...
        public IResult HandleBruteForceCracking(HttpContext httpContext)
        {
            ...
            ILogService.LogInfo(logServices, "Final cracking time with brute force method was: 03:34:10");
            return Results.Ok("Started brute force password cracking.");
        }
        ...
        public IResult HandleDictionaryCracking(HttpContext httpContext)
        {
            ...
            ILogService.LogInfo(logServices, "Final cracking time with dictionary method was: 01:34:10");
            return Results.Ok("Started dictionary password cracking.");
        }
    }
}